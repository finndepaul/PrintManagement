            ...
            modelBuilder.Entity("PrintManagement.Domain.Entities.Team", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2024, 7, 12, 8, 11, 26, 698, DateTimeKind.Local).AddTicks(9476),
                        ...
                        new
                        {
                            ...
                            CreateTime = new DateTime(2024, 7, 12, 8, 11, 26, 698, DateTimeKind.Local).AddTicks(9490),
                        ...
                        new
                        {
                            ...
                            CreateTime = new DateTime(2024, 7, 12, 8, 11, 26, 698, DateTimeKind.Local).AddTicks(9492),
            ...
            modelBuilder.Entity("PrintManagement.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2024, 7, 12, 8, 11, 26, 698, DateTimeKind.Local).AddTicks(9503),
                            DateOfBirth = new DateTime(2024, 7, 12, 8, 11, 26, 698, DateTimeKind.Local).AddTicks(9504),
                            Email = "abc@gmail.com",
                            FullName = "Bùi Duy Đông",
                            IsActive = true,
                            Password = "$2a$11$6QZI4dWlptyV47fZtFr/4elDPcDKvRhg5cm4OBKHbGFX.DOAsDKT.",
                        ...
                        new
                        {
                            ...
                            Avatar = "data:image/png;base64,",
                            CreateTime = new DateTime(2024, 7, 12, 8, 11, 26, 828, DateTimeKind.Local).AddTicks(1295),
                            DateOfBirth = new DateTime(2024, 7, 12, 8, 11, 26, 828, DateTimeKind.Local).AddTicks(1311),
                            Email = "abcd@gmail.com",
                            FullName = "Nguyễn Nhật Mai",
                            IsActive = true,
                            Password = "$2a$11$.DbmojaQCaAl7Zj87oDPMekJT8MiNo965BmkYXbIzy7S/fEl4aE/e",
